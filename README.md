...
[codecatalyst](http://codecatalyst.github.io)
...
1. git clone https://github.com/codecatalyst/codecatalyst.github.com.git 替换为你的目录名
...
1. 我使用我的id作为了一些设置的属性名、文件名、目录名，如果你想修改，最好使用替换工具，把所有文件中的"codecatalyst"，替换为你想要的名字 然后重命名以我的id为名的所有文件和目录
...
为了自定义导航栏子栏目的顺序，重写了这部分的逻辑，具体在文件\_include/codecatalyst/navigation\_list中
